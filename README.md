...
This project uses `countries.json` data, which is automatically generated by the [Wikipedia Country Info Scraper](https://github.com/mucadoo/country-info-scraper).
